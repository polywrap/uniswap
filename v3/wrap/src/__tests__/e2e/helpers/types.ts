// NOTE: This is generated by 'polywrap codegen', DO NOT MODIFY
...
/* URI: "w3://ens/ethereum.web3api.eth" */
export interface Ethers_TxOverrides {
  gasLimit?: BigInt | null;
  gasPrice?: BigInt | null;
  value?: BigInt | null;
}
...
export interface Ethers_TxResponse {
  ...
  v?: UInt32 | null;
  type?: UInt32 | null;
  accessList?: Array<Ethers_Access> | null;
}

/* URI: "w3://ens/ethereum.web3api.eth" */
export interface Ethers_Access {
  address: String;
...
/* URI: "w3://ens/ethereum.web3api.eth" */
export interface Ethers_EventNotification {
  data: String;
  address: String;
  log: Ethers_Log;
}
...
export interface ERC20_Ethers_Connection {
  node?: String | null;
  networkNameOrChainId?: String | null;
}
